...
#################################################################################################################
RESULTS_FOLDER=~/printer_data/adxl_results # Path to the folder where storing the results files
SCRIPTS_FOLDER=~/printer_data/config/ # Path to the folder where the graph_vibrations.py is located
